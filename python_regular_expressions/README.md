...
Строковый метод ``index()`` возбуждает исключение, если подстрока не найдена, в то время как метод ``find()`` возвращает значение ``−1``.<br>
...
![image](https://github.com/tvgVita69/python_begin/assets/98489171/81334d82-4949-4ba3-b1ca-301bfacbbdc2)
...
- Примечание 2. О регулярных выражениях на википедии можно почитать по
  [ссылке](https://ru.wikipedia.org/wiki/Регулярные_выражения/)
